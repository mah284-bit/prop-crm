        ...
        {selCard&&(()=>{
          ...
          return(
            <div style={{width:260,flexShrink:0,background:"#fff",border:"1.5px solid #E2E8F0",borderRadius:12,overflowY:"auto",boxShadow:"0 4px 20px rgba(11,31,58,.08)"}}>
              {/* Header */}
              <div style={{background:"linear-gradient("+m.c+"CC)",padding:"14px 16px",borderRadius:"10px 10px 0 0"}}>
                <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
                  <div>
        ...
        {companies.map(c => {
          ...
          return (
            <div key={c.id}
              ...
              {/* Colour bar */}
              <div style={{height:5,background:"linear-gradient("+c.brand_accent||"#C9A84C"+")"}}/>
