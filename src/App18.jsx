...
const PROJ_STATUS   = ["Active","Upcoming","Completed","On Hold"];
const UNIT_STATUS   = ["Available","Reserved","Under Offer","Sold","Leased","Blocked","Maintenance"];
      ...
      {view === "browser" && (
        <div style={{ display:"flex", gap:12, flex:1, overflow:"hidden" }}>
                  ...
                  <div style={{ flex:1, display:"flex", flexDirection:"column", overflow:"hidden" }}>
                    ...
                    <div style={{ flex:1, overflowY:"auto", display:"grid", gridTemplateColumns:"repeat(auto-fill,minmax(220px,1fr))", gap:10, alignContent:"start" }}>
                      {shown.map(u => {
                        const sp  = getSP(u.id);
                        const lp  = getLP(u.id);
                        const sc  = STATUS_COLOR[u.status] || {c:"#718096",bg:"#F0F2F5"};
          ...
          {selUnit && (() => {
            ...
            const sc  = STATUS_COLOR[selUnit.status] || {c:"#718096",bg:"#F0F2F5"};
