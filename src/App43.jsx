        ...
        <div style={{display:"flex",flex:1,overflow:"hidden",gap:0}}>
          ...
          <div style={{width:210,flexShrink:0,background:"#fff",borderRight:"1px solid #E2E8F0",overflowY:"auto",padding:"14px 12px",display:"flex",flexDirection:"column",gap:12}}>
            ...
            {[
              ...
              {lbl:"Type",        el:<div style={{display:"flex",gap:4}}>{["All","Residential","Commercial"].map(t=><button key={t} onClick={()=>{setFType(t);setFCat("All");}} style={{flex:1,padding:"5px 2px",borderRadius:6,border:`1.5px solid ${fType===t?"#0B1F3A":"#E2E8F0"}`,background:fType===t?"#0B1F3A":"#fff",color:fType===t?"#fff":"#4A5568",fontSize:10,cursor:"pointer",fontWeight:fType===t?700:400}}>{t==="All"?"All":t==="Residential"?"🏘 Res":"🏢 Com"}</button>}</div>},
