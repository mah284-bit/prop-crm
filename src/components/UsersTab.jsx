// UsersTab — extracted from App.jsx (MAP A8)
...
export default function UsersTab({currentUser, showToast}) {
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",height:"100%"}}>
      ...
      <div style={{display:"flex",gap:8,marginBottom:10,alignItems:"center",flexWrap:"nowrap"}}>
        <input value={qText} onChange={e=>setQText(e.target.value)} placeholder="🔍 Search name or email…" style={{width:220,flexShrink:0,padding:"6px 10px",borderRadius:6,border:"1px solid #E2E8F0",fontSize:12}}/>
        <select value={fRole} onChange={e=>setFRole(e.target.value)} style={{width:140,flexShrink:0,padding:"6px 8px",borderRadius:6,border:"1px solid #E2E8F0",fontSize:12,color:"#0F2540"}}>
        ...
        <select value={fStatus} onChange={e=>setFStatus(e.target.value)} style={{width:140,flexShrink:0,padding:"6px 8px",borderRadius:6,border:"1px solid #E2E8F0",fontSize:12,color:"#0F2540"}}>
          <option value="all">All status</option>
          <option value="active">Active</option>
          <option value="inactive">Inactive</option>
        </select>
        {isSuperAdmin && (
          <select value={fCompany} onChange={e=>setFCompany(e.target.value)} style={{width:140,flexShrink:0,padding:"6px 8px",borderRadius:6,border:"1px solid #E2E8F0",fontSize:12,color:"#0F2540"}}>
