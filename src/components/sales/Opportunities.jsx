...
function Opportunities({CreateOpportunityDialog, onActivityLog, leads, setLeads, opps, setOpps, units, projects, salePricing, activities, setActivities, currentUser, users, showToast, initialFilter=null }) {
