...
const TABS=[
  // ── Sales CRM ──────────────────────────────────────────────────
  {id:"dashboard",  label:"Dashboard",    icon:"⊞",  app:"sales",   roles:["admin","sales_manager","sales_agent","viewer"]},
  {id:"builder",    label:"Inventory",    icon:"🏗", app:"sales",   roles:["admin"]},
  {id:"leads",      label:"Leads",        icon:"👤", app:"sales",   roles:["admin","sales_manager","sales_agent"]},
  {id:"pipeline",   label:"Pipeline",     icon:"⬡", app:"sales",   roles:["admin","sales_manager","sales_agent"]},
  {id:"discounts",  label:"Discounts",    icon:"⚡", app:"sales",   roles:["admin","sales_manager"]},
  {id:"activity",   label:"Activity Log", icon:"📋", app:"sales",   roles:["admin","sales_manager","sales_agent"]},
  {id:"ai",         label:"AI Assistant", icon:"✦",  app:"sales",   roles:["admin","sales_manager","sales_agent"]},
  {id:"users",      label:"Users",        icon:"👥", app:"sales",   roles:["admin"]},
  // ── Leasing CRM ────────────────────────────────────────────────
  {id:"l_dashboard",label:"Dashboard",    icon:"⊞",  app:"leasing", roles:["admin","leasing_manager","leasing_agent","viewer"]},
  {id:"l_inventory",label:"Inventory",    icon:"🏗", app:"leasing", roles:["admin"]},
  {id:"leasing",    label:"Leasing",      icon:"🔑", app:"leasing", roles:["admin","leasing_manager","leasing_agent"]},
  {id:"l_discounts",label:"Discounts",    icon:"⚡", app:"leasing", roles:["admin","leasing_manager"]},
  {id:"l_activity", label:"Activity Log", icon:"📋", app:"leasing", roles:["admin","leasing_manager","leasing_agent"]},
  {id:"l_ai",       label:"AI Assistant", icon:"✦",  app:"leasing", roles:["admin","leasing_manager","leasing_agent"]},
  {id:"l_users",    label:"Users",        icon:"👥", app:"leasing", roles:["admin"]},
];

// Who can see the app switcher
const CAN_SWITCH_APP = ["admin","sales_manager","leasing_manager"];
    ...
    <div style={{display:"flex",flexDirection:"column",height:"100vh",background:"#F0F2F5",overflow:"hidden"}}>
      ...
      <div style={{flex:1,overflow:"hidden",padding:"0 1.5rem 1.5rem"}}>
        {dataLoading?<Spinner msg="Loading your data…"/>:(<>
          ...
          {tab==="l_dashboard" &&<div style={{height:"100%",overflowY:"auto",paddingRight:4}}><Dashboard leads={[]} properties={properties} activities={activities} currentUser={currentUser} meetings={[]} followups={[]}/></div>}
