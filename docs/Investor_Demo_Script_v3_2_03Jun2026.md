...
> **HONESTY NOTE:** Al Mansoori is our **design/test brokerage** (we built the product around their workflows) — NOT a signed paying customer. If asked, say "design partner" or "test brokerage," never "signed/anchor customer." Pilots forming, not yet signed.
...
>
> What we need from you: capital to launch our first pilot brokerages and scale to the next ten, to add developer-side integrations, to scale the AI verification layer.
>
